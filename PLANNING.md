...
1. Estrutura Base (HTML, CSS).
2. Configuração de Segurança (Branch Protection, SECURITY.md).
3. Integração e Exibição dos Projetos via READMEs.
4. Configuração do GitHub Pages.

**Responsável:** Heloisa Rodrigues
